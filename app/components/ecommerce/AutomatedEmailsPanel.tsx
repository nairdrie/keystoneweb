...
const ORDER_EMAILS: EmailConfig[] = [
    {
        key: 'order_confirmed',
        label: 'Order Confirmed',
        description: 'Sent to customers immediately after they place an order.',
        defaultSubject: 'Order Confirmed — [ref]',
        defaultHeading: 'Order Confirmed',
        defaultSubheading: 'Thank you for your order, [customer name]!',
        defaultFooter: 'Powered by Keystone Web Design',
    },
    {
        key: 'order_payment_confirmed',
        label: 'Payment Received',
        description: 'Sent when you mark an e-transfer order as paid.',
        defaultSubject: 'Payment Received — Order Confirmed — [ref]',
        defaultHeading: 'Payment Received — Order Confirmed',
        defaultSubheading: '[ref]',
        defaultFooter: 'Powered by Keystone Web Design',
    },
    {
        key: 'order_shipped',
        ...
        defaultSubject: 'Your order has shipped — [ref]',
        defaultHeading: 'Your order has shipped',
        defaultSubheading: "Thanks [customer name] — it's on its way!",
        defaultFooter: 'Powered by Keystone Web Design',
    },
    {
        key: 'order_cancelled',
        ...
        defaultSubject: 'Order Cancelled — [ref]',
        defaultHeading: 'Order Cancelled',
        defaultSubheading: 'Your order [ref] has been cancelled.',
        defaultFooter: 'Powered by Keystone Web Design',
    },
    {
        key: 'mixed_order_confirmed',
        label: 'Multi-Vendor Order',
        description: 'Sent when a cart contains items from multiple vendors.',
        defaultSubject: 'Order Received — [ref]',
        defaultHeading: 'Order Received',
        defaultSubheading: 'Thank you for your order, [customer name]!',
        defaultFooter: 'Powered by Keystone Web Design',
    },
];
...
export default function AutomatedEmailsPanel({ siteId, logoUrl }: Props) {
    const [customizations, setCustomizations] = useState<Record<string, EmailOverrides>>({});
    const [selected, setSelected] = useState<string>(ORDER_EMAILS[0].key);
    ...
    const config = ORDER_EMAILS.find(e => e.key === selected)!;
    ...
    return (
        <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
            ...
            <div className="flex divide-x divide-slate-200" style={{ minHeight: 480 }}>
                {/* Sidebar */}
                    ...
                    <div className="px-5 pt-5 pb-4 flex-1">
                        ...
                        <div className="space-y-4">
                            <Field
                                ...
                                hint="Leave blank to use the default. Note: order references are added automatically."
                            />
                            <Field
                                label="Heading"
...
<body style="margin:0;padding:16px;background:#f3f4f6;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;">
  <div style="max-width:480px;margin:0 auto;background:#fff;border-radius:12px;overflow:hidden;box-shadow:0 1px 3px rgba(0,0,0,.1);">
    <div style="padding:24px 24px 16px;text-align:center;">
      ...
      <p style="margin:0;color:#6b7280;font-size:14px;">${escapeHtml(subheading)}</p>
    </div>
    <div style="padding:0 24px 16px;">
      <div style="background:#f9fafb;border-radius:8px;padding:16px;">
        <table style="width:100%;border-collapse:collapse;font-size:14px;">
          <tr><td style="padding:6px 0;color:#6b7280;">Item</td><td style="padding:6px 0;text-align:center;color:#6b7280;">Qty</td><td style="padding:6px 0;text-align:right;font-weight:600;color:#111827;">Price</td></tr>
          <tr><td style="padding:6px 0;color:#111827;">Sample Product</td><td style="padding:6px 0;text-align:center;color:#6b7280;">x1</td><td style="padding:6px 0;text-align:right;font-weight:600;color:#111827;">$29.99</td></tr>
          <tr><td colspan="2" style="padding:8px 0 4px;border-top:1px solid #e5e7eb;color:#111827;font-weight:700;">Total</td><td style="padding:8px 0 4px;border-top:1px solid #e5e7eb;text-align:right;font-weight:700;color:#111827;font-size:16px;">$29.99 CAD</td></tr>
        </table>
      </div>
      <p style="margin-top:12px;font-size:12px;color:#9ca3af;text-align:center;">Ref: ORDER-A1B2C3D4</p>
