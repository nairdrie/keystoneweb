            ...
            {changes && changes.length > 0 && (
              <div className="mb-6">
                ...
                <button
                  ...
                  className="w-full flex items-center justify-between px-4 py-3 bg-amber-50 border border-amber-200 rounded-lg hover:bg-amber-100 transition-colors group"
                >
