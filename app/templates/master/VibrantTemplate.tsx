                    ...
                    {mobileMenuOpen && (
                        <div className="md:hidden border-t border-white/20 py-4 space-y-2">
                            ...
                            <EditableButton
                                ...
                                isEditMode={isEditMode}
                                onSave={updateSiteContent}
                                className="w-full mt-3 px-5 py-2.5 rounded-full font-bold text-sm bg-white cursor-pointer inline-flex items-center justify-center"
                ...
                <div className="max-w-6xl mx-auto px-4">
                    <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-8 text-center">
                        <div className="flex items-center justify-center gap-2 mb-3">
                            {siteContent.siteLogo ? (
                                <img src={siteContent.siteLogo} alt="" className="w-7 h-7 object-contain"  style={{ height: siteContent.footerLogoHeight ? `${siteContent.footerLogoHeight}px` : undefined, width: siteContent.footerLogoHeight ? 'auto' : undefined }} />
                            ) : (
