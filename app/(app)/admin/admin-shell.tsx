              ...
              {isRenaming ? (
                ...
                <div className="flex items-center gap-2 flex-wrap">
                  ...
                  <div className="relative group shrink-0 mt-0.5">
                    ...
                    <div className="absolute left-1/2 -translate-x-1/2 top-full mt-1.5 w-64 bg-slate-800 text-white text-xs leading-relaxed rounded-lg px-3 py-2.5 shadow-lg opacity-0 pointer-events-none group-hover:opacity-100 group-hover:pointer-events-auto transition-opacity z-50">
