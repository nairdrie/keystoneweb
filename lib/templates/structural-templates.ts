...
const customizables = {
  ...
  menu: ['menuTitle', 'menuSubtitle', 'variant', 'fallbackItems'],
  booking: ['services', 'availability'],
  blog: ['title', 'subtitle', 'layout', 'fallbackPosts'],
    ...
    default_content: {
      ...
      blocks: [
        ...
        block('blog', {
          ...
          postsPerPage: 4,
          fallbackPosts: [
            { id: 'ed-p1', title: 'The case for smaller, sharper websites', slug: 'smaller-sharper-websites', excerpt: 'A practical look at why content architecture beats bloated pages.', cover_image: image('photo-1495020689067-958852a7765e'), author: 'Avery Stone', tags: ['Strategy'], is_published: true, published_at: '2026-04-18T12:00:00.000Z', created_at: '2026-04-18T12:00:00.000Z' },
            { id: 'ed-p2', title: 'How to turn expertise into a repeatable column', slug: 'repeatable-column', excerpt: 'Simple editorial formats that help busy experts publish consistently.', cover_image: image('photo-1516321318423-f06f85e504b3'), author: 'Nora Bell', tags: ['Publishing'], is_published: true, published_at: '2026-04-11T12:00:00.000Z', created_at: '2026-04-11T12:00:00.000Z' },
            { id: 'ed-p3', title: 'What your about page should actually do', slug: 'about-page-job', excerpt: 'Move beyond biography and create useful context for trust.', cover_image: image('photo-1497366754035-f200968a6e72'), author: 'Mika Lane', tags: ['Brand'], is_published: true, published_at: '2026-04-04T12:00:00.000Z', created_at: '2026-04-04T12:00:00.000Z' },
          ],
        }),
        block('team', {
          title: 'Byline',
    ...
    default_content: {
      ...
      blocks: [
        ...
        block('tabBar', {
          ...
          items: [
            { id: 'menu-tab-brunch', label: 'Brunch', linkType: 'section', href: '#menu' },
            { id: 'menu-tab-dinner', label: 'Dinner', linkType: 'section', href: '#menu' },
            { id: 'menu-tab-drinks', label: 'Drinks', linkType: 'section', href: '#menu' },
          ],
        }),
        block('menu', {
          menuTitle: 'Menu highlights',
          menuSubtitle: 'A preview of guest favorites. Connect the admin menu to publish the full list.',
          variant: 'cards',
          showPrices: true,
          ...
          backgroundColor: 'palette:accent',
          fallbackItems: [
            { id: 'menu-1', name: 'Charred Broccolini', description: 'Lemon aioli, chili crisp, toasted almond.', price: '$14', category: 'Small Plates', image_url: image('photo-1546069901-ba9599a7e63c'), is_available: true, sort_order: 1 },
            { id: 'menu-2', name: 'Brown Butter Gnocchi', description: 'Sage, parmesan, roasted squash.', price: '$24', category: 'Dinner', image_url: image('photo-1473093295043-cdd812d0e601'), is_available: true, sort_order: 2 },
            { id: 'menu-3', name: 'Citrus Olive Cake', description: 'Whipped mascarpone and seasonal citrus.', price: '$11', category: 'Dessert', image_url: image('photo-1488477181946-6428a0291777'), is_available: true, sort_order: 3 },
          ],
        }),
        block('gallery', {
      ...
      extra_pages: [
        {
          ...
          blocks: [
            block('menu', {
              ...
              fallbackItems: [
                { id: 'full-menu-1', name: 'Seasonal Salad', description: 'Greens, herbs, pickled shallot, vinaigrette.', price: '$16', category: 'Starters', image_url: '', is_available: true, sort_order: 1 },
                { id: 'full-menu-2', name: 'Roast Chicken', description: 'Pan jus, crispy potatoes, bitter greens.', price: '$29', category: 'Mains', image_url: '', is_available: true, sort_order: 2 },
              ],
            }),
          ],
        },
